...
TEXTS = {
    "en": {
        ...
        "token_error": "❌ <b>Invalid token.</b> Make sure to copy the full token generated by @BotFather.\n\n🛡️ <i>Cloud Media Management</i>",
    ...
    "es": {
        ...
        "token_error": "❌ <b>Token inválido.</b> Asegúrate de copiar el token completo generado por @BotFather.\n\n🛡️ <i>Cloud Media Management</i>",
...
async def handle_private_inputs(message: Message, bot: Bot):
    ...
    if user_id in CLONE_STATES:
        ...
        if ":" in token and len(token) > 30:
            ...
            await message.answer(t["token_success"], reply_markup=back_kb, parse_mode="HTML")
        else:
